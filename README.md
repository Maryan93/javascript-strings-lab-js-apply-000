...
Next, the title tells us that `"Hello, everybody!"` "defines `greeting`." Let's look in `"Hello, everybody!"` — sure enough, we see, at the top of the file, `var greeting = "";`. Seems like a reasonable place to start.
